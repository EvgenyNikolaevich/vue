...
**Цель:**  
Научиться проектировать и реализовывать сложные JavaScript-приложения с использованием библиотеки Vue.js.  
...
Разработать одностраничное приложение со следующим функционалом:  
  ...
  2. У каждой сущности как минимум должен быть заголовок, небольшое описание, дата создания и состояние Like    
...
**Цель:**  
Научиться проектировать и реализовывать сложные JavaScript-приложения с использованием библиотеки Vuex  
